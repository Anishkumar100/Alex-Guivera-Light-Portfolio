...
const STEPS = [
  {
    ...
    shape: (
      <svg viewBox="0 0 120 120" className="h-full w-full fill-none stroke-white opacity-30">
  ...
  },
  {
    ...
    shape: (
      <svg viewBox="0 0 120 120" className="h-full w-full fill-none stroke-white opacity-30">
        ...
        <circle cx="40" cy="75" r="2" fill="white" stroke="none" />
        <circle cx="55" cy="95" r="2" fill="white" stroke="none" />
      </svg>
    )
  },
  {
    ...
    shape: (
      <svg viewBox="0 0 120 120" className="h-full w-full fill-none stroke-white opacity-30">
        ...
        <circle cx="60" cy="60" r="6" fill="white" fillOpacity="0.15" strokeWidth="1" />
  ...
  },
  {
    ...
    shape: (
      <svg viewBox="0 0 120 120" className="h-full w-full fill-none stroke-white opacity-30">
        ...
        <circle cx="60" cy="60" r="8" fill="white" fillOpacity="0.1" strokeWidth="1.5" />
        <circle cx="60" cy="60" r="3" fill="white" stroke="none" />
    ...
    <section ref={containerRef} className="relative min-h-screen w-full overflow-hidden px-6 py-32 md:px-12">
      <div className="mx-auto w-full max-w-[1200px]">
        ...
        <div className="relative mx-auto flex w-full flex-col">
          ...
          <div className="absolute left-6 top-0 h-full w-[2px] border-l-2 border-dashed border-[rgba(255,255,255,0.06)] md:left-1/2 md:-translate-x-1/2" />
          
          {/* Animated Solid Line */}
          <div 
            ref={lineRef}
            className="absolute left-6 top-0 h-full w-[2px] origin-top bg-white md:left-1/2 md:-translate-x-1/2"
            ...
            {STEPS.map((step, idx) => {
              ...
              return (
                <div key={idx} className={`relative flex w-full flex-col md:flex-row ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} items-center`}>
                  ...
                  <div className="absolute left-6 top-1/2 z-10 h-4 w-4 -translate-x-[7px] -translate-y-1/2 rounded-full border-2 border-white bg-void md:left-1/2 transition-shadow duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]" />
