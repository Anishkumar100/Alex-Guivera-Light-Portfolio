      ...
      <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-16 lg:flex-row lg:gap-24">
        ...
        <div className="flex w-full flex-col lg:w-7/12">
          ...
          >
            ...
            <h2 className="mb-8 font-display text-[2rem] font-bold leading-tight text-white md:text-[2.5rem]">
        ...
        <div className="flex w-full items-start lg:w-5/12 lg:pt-12">
          <motion.div
            ...
            className="flex flex-col border-l-2 border-accent-primary bg-[rgba(255,255,255,0.02)] p-8 md:p-10"
          >
            <span className="mb-6 block font-mono text-[11px] uppercase tracking-[0.2em] text-accent-primary">
              The Solution
            </span>
            <p className="font-display text-[1.5rem] font-medium leading-snug text-white md:text-[1.75rem]">
