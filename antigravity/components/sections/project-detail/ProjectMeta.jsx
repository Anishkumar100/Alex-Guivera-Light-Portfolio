...
export default function ProjectMeta({ project }) {
  ...
  return (
    <section className="relative w-full border-b border-[rgba(10,9,20,0.05)] bg-void-2 px-6 py-16 md:px-12 md:py-20">
        ...
        {metaItems.map((item, idx) => (
          <motion.div 
            ...
            className={`flex flex-col py-6 md:py-0 md:px-8 lg:px-16 ${
              idx !== 0 ? 'border-t border-[rgba(10,9,20,0.05)] md:border-t-0 md:border-l' : ''
          ...
          >
            ...
            <span className="font-display text-[1.25rem] font-bold text-[var(--text-primary)] md:text-[1.5rem]">
              {item.value}
            </span>
          </motion.div>
        ))}
