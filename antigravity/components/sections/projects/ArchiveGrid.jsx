  ...
  return (
    <section className="relative w-full px-6 py-32 md:px-12">
      <div className="mx-auto w-full max-w-[1200px]">
        ...
        <div className="hidden grid-cols-12 border-b border-[rgba(255,255,255,0.1)] pb-4 md:grid">
        ...
        <div className="flex flex-col">
          {ARCHIVE_PROJECTS.map((project, idx) => (
            <motion.a
              ...
              className="group grid grid-cols-1 gap-4 border-b border-[rgba(255,255,255,0.05)] py-6 transition-colors duration-500 hover:bg-[rgba(255,255,255,0.02)] hover:px-4 md:grid-cols-12 md:items-center md:gap-0 md:py-8"
            >
              {/* Project Name */}
              ...
              <div className="hidden justify-end md:col-span-1 md:flex">
                <div className="flex h-12 w-12 items-center justify-center rounded-full border border-[rgba(255,255,255,0.1)] text-text-dim transition-all duration-500 group-hover:scale-110 group-hover:border-accent-primary group-hover:bg-accent-primary/10 group-hover:text-accent-primary">
